...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button shuping = findViewById(R.id.shuping);
        shuping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            }
        });
        Button hengping = findViewById(R.id.hengping);
        hengping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        Button tran_1 = (Button)findViewById(R.id.tran);
        Button tran_2 = (Button)findViewById(R.id.tran1);
        Button chengfang = findViewById(R.id.chengfang);
        Button kaifang = findViewById(R.id.kaifang);
        Button zuokuohao = findViewById(R.id.zuokuohao);
        Button youkuohao = findViewById(R.id.youkuohao);
            ...
            public void onClick(View v) {
                ...
                if(!show_equation.toString().equals("")){
                    ...
                    for(int i=0;i<show_equation.length();i++){
                        if(show_equation.charAt(i)>='0'&&show_equation.charAt(i)<='9'||show_equation.charAt(i)=='.'||show_equation.charAt(i)=='c'
                        ||show_equation.charAt(i)=='o'||show_equation.charAt(i)=='s'||show_equation.charAt(i)=='i'||show_equation.charAt(i)=='a'
                                ||show_equation.charAt(i)=='n'||show_equation.charAt(i)=='t'){
                            temp1.append(String.valueOf(show_equation.charAt(i)));
                        }else if(show_equation.charAt(i)=='('){
                            temp1.append(String.valueOf(show_equation.charAt(i)));
                            i+=1;
                            for(;show_equation.charAt(i)!=')';i++){
                                temp1.append(String.valueOf(show_equation.charAt(i)));
                            }
        ...
        tran_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        tran_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        chengfang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(!(show_equation.toString().equals(""))) {
                    signal=0;
    ...
    public static double sin(double d1){
        return Math.sin(d1/180*Math.PI);
    }
    public static double cos(double d1){
        return Math.cos(d1/180*Math.PI);
    }
    public static double tan(double d1){
        return Math.tan(d1/180*Math.PI);
    }
    public static double chengfang(double d1,double d2){
        return Math.pow(d1,d2);
    }
    public static double kaifang(double d1,double d2){
        ...
        for(int i=0;i<equation.size();i++) {
            ...
            if (cs == '(') {
                for (int j = 1; cs != ')'; j++) {
                    ...
                    if (cs == '+' || cs == '-' || cs == '*' || cs == '/' || cs == '^' || cs == '√') {
                        if (operator.size() > 0) {
                            String temp5 = operator.get(operator.size() - 1).toString();
                            while (!(operatorPriorityCompare(cs, temp5.charAt(0))) && operator.size() > 0) {
                                ...
                                switch (temp5.charAt(0)) {
                                    ...
                                    case '^': {
                                        result = chengfang(temp2, temp3);
                                        operand.add(result);
                                        break;
                                    }
                                    case '√': {
                                        result = kaifang(temp2, temp3);
                                        operand.add(result);
                                        break;
                                    }
                                }
                            ...
                            operator.add(cs);
                        System.out.println("符栈");
                        System.out.println(operator);
                    } else if (cs == ')') {
                        while (operator.size() > 0) {
                            char temp6 = (char) operator.get(operator.size() - 1);
                            operator.remove(operator.size() - 1);
                            temp3 = operand.get(operand.size() - 1);
                            operand.remove(operand.size() - 1);
                            temp2 = operand.get(operand.size() - 1);
                        ...
                        if (!(cs == 'c' || cs == 's') || cs == 't')
                            operand.add((double) Character.getNumericValue(cs));
                ...
                if (cs == 's' || cs == 'c' || cs == 't') {
                    ...
                    for (int j = 3; j < temp4.length(); j++) {

                        cs1 = temp4.charAt(j);
                        t += cs1;
                    }
                    double num = Double.parseDouble(t.toString().trim());
                ...
                } else if (temp4.equals("+") || temp4.equals("-") || temp4.equals("*") || temp4.equals("/") || temp4.equals("^") || temp4.equals("√")) {
                    if (operator.size() > 0) {
                        String temp5 = operator.get(operator.size() - 1).toString();
                    ...
                    if (temp4.equals("NaN")) {
                        ...
                        if (!(cs == 'c' || cs == 's') || cs == 't')
                            operand.add(Double.parseDouble(temp4.toString().trim()));
                    }
                }
            }
        }
